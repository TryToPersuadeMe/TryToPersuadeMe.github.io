...
function initSky() {
  ...
  // const geometry = new THREE.SphereGeometry(225, 32, 32);
  // const material = new THREE.MeshBasicMaterial({ color: 0xd26600 });
  // const sphere = new THREE.Mesh(geometry, material);
  // sphere.alphaMap = white;
...
function init() {
  ...
  const helper = new THREE.GridHelper(10000, 25, 0x95f2f2, 0x95f2f2);
  scene.add(helper);
