...
let light = new THREE.DirectionalLight(0xaf3b56, 0.5);
light.position.set(0, 80, -250);
scene.add(light, new THREE.AmbientLight(0xaf3b56, 2.5));
...
//sun
let sg = new THREE.CircleGeometry(45, 64);
