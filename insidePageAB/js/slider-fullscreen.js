...
$(".slider-fullscreen__row_big").slick({
  slidesToShow: 1,
  slidesToScroll: 1,
  arrows: false,
  fade: true,
  asNavFor: ".slider-fullscreen__row_small",
...
$(".slider-fullscreen__row_small").slick({
  slidesToShow: 6,
  slidesToScroll: 6,
  asNavFor: ".slider-fullscreen__row_big",
  arrows: false,
  dots: false,
  focusOnSelect: true,
  infinite: false,
...
$(".slider-fullscreen__slide_small").on("click", () => {
  $(".slider-fullscreen__slide_small").not(this).removeClass("slider-fullscreen__slide_small-active");

  $(event.currentTarget).addClass("slider-fullscreen__slide_small-active");
});
